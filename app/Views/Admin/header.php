...
<head>
    ...
    <title>Amar Bangla | Super Admin</title>
...
<!--        <img class="animation__shake" src="--><?php //echo base_url()?><!--assets/loading.gif" alt="AdminLTELogo" height="60" width="60">-->
<!--    </div>-->
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?php echo base_url('admin/applicant')?>" class="nav-link">Home</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
